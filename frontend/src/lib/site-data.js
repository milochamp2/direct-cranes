...
const reelVids = (folder, bases) =>
  bases.map((b) => ({
    ...
    poster: `/media/${encodeURIComponent(folder)}/${b}.jpg`,
  }));
...
export const SERVICES = [
  ...
  },
  {
    ...
    image: "/images/helicopter%20jpg/helicopter%205.jpg",
    gallery: galleryImgs(
      "helicopter jpg",
      ["helicopter 1.jpg", "helicopter 2.jpg", "helicopter 3.jpg", "helicopter 4.jpg", "hc gary.jpg"],
      "Direct Cranes helicopter lifting operation"
    ),
    videos: reelVids("helicopter vids", ["heli-1", "heli-2", "heli-3", "heli-4", "heli-5", "heli-6"]),
    machines: ["HELI"],
  },
  {
    slug: "heavy-haulage",
  ...
  },
  {
    ...
    chapter: "05",
    title: "Lift Studies",
    short: "3D lift studies and CAD drawings, software-verified in Liebherr Liccon, with full safety documentation.",
    lede: "Every complex lift starts on paper. From a straightforward lift plan to a fully engineered, software-verified study — we model, calculate and document the pick before a load leaves the ground.",
    body: [
      "Our planners build each lift in CAD and 3D, then verify it in Liebherr Liccon and OEM load-chart software — confirming crane configuration, working radius, boom clearances and capacity for every pick.",
      "You receive a complete documentation pack — lift plan or study, SWMS, and crane and rigging certification — ready for your site safety team before mobilisation.",
    ],
    capabilities: ["3D lift studies & CAD drawings", "Liebherr Liccon & OEM software", "Crane configuration & load charts", "SWMS & safety documentation", "Engineered & designed lifts", "On-site lift supervision"],
    specs: [
      { k: "Planning", v: "CAD & 3D" },
      { k: "Software", v: "Liccon · OEM" },
      { k: "Docs", v: "Full safety pack" },
    ],
    tiers: [
      { name: "Lift Plan", tag: "The essentials", desc: "Crane position, load path, rigging arrangement and SWMS — everything a routine lift needs, documented and signed off." },
      { name: "Lift Study", tag: "Modelled in 3D", desc: "CAD and 3D modelling of the crane setup, boom clearances, exclusion zones and load paths, checked before mobilisation." },
      { name: "Engineered Lift", tag: "Software-verified", desc: "Liebherr Liccon and OEM load-chart software confirm configuration, radius and capacity for heavy and critical picks." },
      { name: "Designed Lift", tag: "Fully engineered", desc: "Custom rigging and lifting-frame design with engineering sign-off for the most complex, high-value lifts." },
    ],
    considerations: [
      "Site constraints, access & timing",
      "Environmental & third-party impacts",
      "Hazard identification & safety controls",
      "Crane type, size, dimensions & configuration",
      "Outrigger loads & ground bearing pressures",
      "Road access permits & counterweight transport",
      "Rigging the load safely, without damage",
    ],
    headerImage: "/images/crane/crane%203.jpg",
    whyChoose: [
      { icon: "cpu", title: "Software-verified", desc: "Every study is confirmed in Liebherr Liccon and OEM load-chart software — capacity, radius and configuration checked, not guessed." },
      { icon: "boxes", title: "Modelled in 3D & CAD", desc: "Crane setup, boom clearances, exclusion zones and load paths are drawn and modelled before anyone mobilises." },
      { icon: "building", title: "One company, end to end", desc: "The team that plans your lift also supplies the crane, crew and haulage — no gaps between paper and site." },
      { icon: "shield", title: "Documented for safety", desc: "SWMS, load charts and crane and rigging certification, packaged and ready for your site safety team." },
      { icon: "map", title: "Local site knowledge", desc: "Plans built around real access, ground conditions and permits across Victoria, Queensland and South Australia." },
      { icon: "zap", title: "Fast turnaround", desc: "Lift plans and studies produced quickly so tenders, approvals and programmes keep moving." },
    ],
    projects: [
      { img: "/images/crane/mobile.jpg", title: "Confined-access CBD lift", desc: "All-terrain crane threaded into a tight Melbourne laneway — access, exclusion zones and permits planned to the metre." },
      { img: "/images/crane/crane%2014.jpg", title: "Plant & tree relocation", desc: "Precision pick-and-set of an established palm on a live earthworks site alongside excavation plant." },
      { img: "/images/crane/crane%2012.jpg", title: "Tandem Franna lift", desc: "Two pick-and-carry cranes rigged for a synchronised load-out inside the yard." },
    ],
...
export const FLEET = [
  {
    ...
    image: "/images/fleet%20mobile%20cranes/fleet-at-100.png",
    vector: true,
  ...
  },
  {
    ...
    image: "/images/fleet%20mobile%20cranes/fleet-at-60.png",
    vector: true,
    serviceSlug: "mobile-cranes",
    specs: [
  ...
  },
  {
    ...
    image: "/images/fleet%20mobile%20cranes/fleet-franna-25.png",
    vector: true,
    serviceSlug: "mobile-cranes",
    specs: [
  ...
  },
  {
    ...
    image: "/images/fleet%20mobile%20cranes/fleet-franna-40.png",
    vector: true,
    serviceSlug: "mobile-cranes",
    specs: [
  ...
  },
  {
    ...
    image: "/images/fleet%20heavy%20haulage/fleet-crawler.png",
    vector: true,
  ...
  },
  {
    ...
    image: "/images/fleet%20helicopter/fleet-heli.png",
    vector: true,
