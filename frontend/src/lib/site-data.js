...
export const SERVICES = [
  {
    ...
    chapter: "01",
    title: "Mobile Cranes",
    short: "All-terrain cranes to 100T, 25T Frannas and heavy slews to 250T — wet hire with certified crews.",
    lede: "From tight-access 25T Frannas to 100T all-terrains and 250T slew cranes — road-legal machines supplied wet with experienced operators, dogmen and riggers.",
    body: [
    ...
    capabilities: ["All-terrain cranes to 100T", "25T Franna pick & carry", "Slew cranes 50T – 250T", "Wet hire — operator, dogman, rigger", "Same-day & emergency mobilisation", "Multi-crane tandem lifts"],
    specs: [
      { k: "Range", v: "25T – 250T" },
...
export const FLEET = [
  ...
  {
    code: "SL-250",
    name: "250T Slew Crawler",
    tagline: "The heavy hitter.",
    blurb: "Lattice boom crawler for structural steel, bridge beams and major infrastructure.",
    image: IMG.slew,
    serviceSlug: "mobile-cranes",
    specs: [
